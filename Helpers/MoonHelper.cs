...
namespace SunriseSunsetApp.Helpers
{
    ...
    {
        public static SunAndMoonData GetData(DateTime dt, double lat, double lng, double TimeZoneDifferenceFromUTC)
        {
        ...
        private static string FindSunAndTwilightDataForDate(SunAndMoonData data, DateTime dt, double tz, double glong, double glat)
        {
            //
        ...
        private static DateTime ConvertToDateTime(DateTime dt, double DecimalHours)
        {
        ...
        private static double sin_alt(double iobj, double mjd0, double hour, double glong, double cglat, double sglat)
        {
            //
        ...
        private static string FindMoonRiseAndSet(SunAndMoonData data, DateTime dt, double tz, double glong, double glat)
        {
            //
